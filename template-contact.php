...
// Shown email = the routed "Contact form" recipient (Settings → TSA Form Emails),
// so the displayed address always matches where the form actually goes.
$contact_email = function_exists( 'tsa_form_recipient' ) ? tsa_form_recipient( 'contact' ) : get_option( 'admin_email' );
    ...
    <div class="tsa-ip-contact">
        ...
        <div class="tsa-ip-methods">
            ...
            <div class="tsa-ip-method">
                ...
                <div>
                    <h3>Location</h3>
                    <p>Baton Rouge, Louisiana<br>Serving Ascension Parish &amp; nationwide</p>
                </div>
            </div>
            <div class="tsa-ip-method">
